...
def line_demo(inter_size, xy_new_coordinate):
    p_start = np.array([xy_new_coordinate[0], xy_new_coordinate[1],  4])
    p_end = np.array([xy_new_coordinate[0], xy_new_coordinate[1],  1])
    ...
    p_start = np.array([xy_new_coordinate[0], xy_new_coordinate[1], 4])
    p_end = np.array([xy_new_coordinate[0], xy_new_coordinate[1], 4])
    # p_start = np.array([20, 0,  0])
    # p_end = np.array([10, 0,  0])
    r_matrix = interpolate_line(p_start, p_end, inter_size)
    print(r_matrix)
